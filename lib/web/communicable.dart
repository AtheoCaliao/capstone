...
class _CommunicablePageState extends State<CommunicablePage> {
  ...
  Future<void> _loadPatients() async {
    try {
      ...
      setState(() {
        _chronicCarePatients = communicableRecords.map((record) {
          return {
            'id': record['id'] ?? '',
            ...
            'bloodSugar': _extractVital(record['details'] ?? '', 'Temp'),
            'bloodPressure': _extractVital(record['details'] ?? '', 'BP'),
          };
        }).toList();
                  ...
                  child: RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Chronic Care Overview Dashboard
  ...
  Widget _buildTopBar(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.coronavirus_rounded, color: _primaryAqua, size: 32),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  label,
                  style: TextStyle(fontSize: 10, color: _mutedCoolGray),
                ),
                const SizedBox(height: 2),
                Text(
                  value,
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildInfoItem('Blood Pressure', patient['bloodPressure']),
              _buildInfoItem('Blood Sugar', patient['bloodSugar']),
